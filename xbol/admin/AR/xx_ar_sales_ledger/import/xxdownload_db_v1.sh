...
FNDLOAD $APPS_USER/$APPS_PWD@$BASE 0 Y DOWNLOAD $FND_TOP/patch/115/import/afcpprog.lct pc_us_xx_ar_sales_ledger_db_v1.ldt PROGRAM APPLICATION_SHORT_NAME="XBOL" CONCURRENT_PROGRAM_NAME="XXZXCLRSLL"

echo 'US - Bajando objeto XXZXCLRSLL'
FNDLOAD $APPS_USER/$APPS_PWD@$BASE 0 Y DOWNLOAD $XDO_TOP/patch/115/import/xdotmpl.lct xdo_us_xx_ar_sales_ledger_db_v1.ldt XDO_DS_DEFINITIONS APPLICATION_SHORT_NAME='XBOL' DATA_SOURCE_CODE='XXZXCLRSLL'

echo 'US - Bajando Grupo de Solicitudes XX_CL_AR_GERENTE para la unidad XXZXCLRSLL'
FNDLOAD $APPS_USER/$APPS_PWD@$BASE 0 Y DOWNLOAD $FND_TOP/patch/115/import/afcpreqg.lct rgu_us_xx_ar_sales_ledger_db_v1.ldt REQUEST_GROUP REQUEST_GROUP_NAME="XX_CL_AR_GERENTE" APPLICATION_SHORT_NAME="XBOL" REQUEST_GROUP_UNIT UNIT_APP="XBOL" UNIT_NAME="XXZXCLRSLL"
