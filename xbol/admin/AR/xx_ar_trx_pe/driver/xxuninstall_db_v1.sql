...
REM |                                                                       |
REM | HISTORY                                                               |
REM |    26-MAY-2017 - 1.0 - AMalatesta - DSP - Created                     |
REM |                                                                       |
REM +=======================================================================|
...
prompt Eliminando concurrente XXARPETRXP
...
declare
  cursor del is
    ...
    and    fcp.concurrent_program_name = 'XXARPETRXP'
...
/
prompt Eliminando ejecutable XXARPETRXP
set serveroutput on size 1000000
declare
  cursor del is
    select fa.application_short_name
    ...
    and    fe.executable_name = 'XXARPETRXP'
