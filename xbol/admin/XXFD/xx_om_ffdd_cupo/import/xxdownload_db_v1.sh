...
FNDLOAD $APPS_USER/$APPS_PWD@$BASE 0 Y DOWNLOAD $XBOL_TOP/admin/XX/util/import/xxflexfields.lct xx_om_ffdd_cupo_db_v1.ldt DESC_FLEX DESCRIPTIVE_FLEXFIELD_NAME=XX_ALL_EXTRA_ATTRIBUTES DESCRIPTIVE_FLEX_CONTEXT_CODE='OOL%' END_USER_COLUMN_NAME="XX_OM_CUPO"
