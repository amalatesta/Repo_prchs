...
#|                                                                       |
#| HISTORY                                                               |
#|     17-MAY-2017 - 1.0 - AMalatesta - DSP - Created                    |
#|                                                                       |
#+=======================================================================*/

rm -rf $XBOL_TOP/patches/xx_ar_rev_chkout_db_v1
rm -rf $XBOL_TOP/patches/xx_ar_rev_chkout_db_v1.tar
...
echo 'Armando el tar'
cd $XBOL_TOP/patches
tar -cvf xx_ar_rev_chkout_db_v1.tar xx_ar_rev_chkout_db_v1
